...
Meio de contato: ${this.state.mcontato}`;
    ...
    render() {
        return (
            <div style={{  margin: '30px',  backgroundColor: '#282c34',
            borderColor:'orange',
            borderStyle: 'solid',
            display: 'flex',
            ...
            color: 'white' }}>
                <div style={{ textAlign: 'center', paddingLeft:'50px'}}><label><b>NOTAS</b></label></div>
                <br />              
                <label >
                    <b>
                        Qual o motivo da solicitação?
                    ...
                    <br />
                    <input type="text" style={{ textAlign: 'center', paddingLeft:'50px'}}name="motivo" value={this.state.motivo} onChange={(e) => this.setState({ motivo: e.target.value })} />
                </label>
                <br />
                <label>
                    <b>
