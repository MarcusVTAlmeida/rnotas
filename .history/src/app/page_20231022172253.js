...
Meio de contato: ${this.state.mcontato}`;
    ...
    render() {
        return (
            <div style={{  padding: '30px',  backgroundColor: '#282c34',
            borderColor:'orange',
            borderStyle: 'solid',
            display: 'flex',
            ...
            margin:'15px' }}>
                ...
                <label>
                    ...
                    <br />
                    <input type="text" style={{ width:400 }}name="ncliente" value={this.state.ncliente} onChange={(e) => this.setState({ volume: e.target.value })} />
                </label>
                <br />         
                <label>
                    <b>
                    ...
                    <br />
                    <input type="text" style={{ width:400 }}name="ncliente" value={this.state.ccliente} onChange={(e) => this.setState({ ccliente: e.target.value })} />
                </label>
                <br />
                <label>
                    <b>
